...
import { _ as _sfc_main$2 } from "./GuestLayout-DWct4yhk.js";
      ...
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="ms-2 text-sm text-text-secondary"${_scopeId}>Recordarme</span></label></div><div class="mt-4 flex flex-col gap-4"${_scopeId}>`);
            ...
            if (__props.canResetPassword) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                class: "text-sm text-text-tertiary underline hover:text-primary focus:outline-none transition-colors"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` ¿Olvidaste tu contraseña? `);
                  } else {
                    return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "mt-4 block" }, [
                  createVNode("label", { class: "flex items-center" }, [
                    ...
                    createVNode("span", { class: "ms-2 text-sm text-text-secondary" }, "Recordarme")
                  ])
                ]),
                createVNode("div", { class: "mt-4 flex flex-col gap-4" }, [
