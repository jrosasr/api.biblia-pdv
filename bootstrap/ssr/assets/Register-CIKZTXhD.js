      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="mt-8 flex flex-col gap-4"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` ¿Ya tienes una cuenta? <span class="font-bold text-primary"${_scopeId2}>Inicia sesión</span>`);
                } else {
                  return [
                    createTextVNode(" ¿Ya tienes una cuenta? "),
                    createVNode("span", { class: "font-bold text-primary" }, "Inicia sesión")
                  ];
                }
              }),
              _: 1
            ...
            return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "mt-8 flex flex-col gap-4" }, [
