                ...
                <div class="bg-surface overflow-hidden shadow-xl sm:rounded-2xl border border-border">
                    <div class="p-8">
                        <header class="mb-8 border-b border-border pb-4 font-bold">
                            ...
                            <p class="text-sm text-text-tertiary mt-1 font-normal">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-border border-dashed rounded-xl hover:bg-surface-alt transition-colors cursor-pointer relative group">
