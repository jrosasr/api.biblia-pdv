    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    class="bg-surface overflow-hidden shadow-sm sm:rounded-2xl border border-border"
                >
                                ...
                                >
                                    ...
                                    >
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div
                                                class="text-[10px] text-text-tertiary font-medium truncate max-w-xs"
                                            >
                                                {{ token.device_id }}
                                            </div>
                                        </td>
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm text-text-secondary font-medium"
                                        >
                                            {{
                                                token.user
                                                    ? token.user.name
            ...
            <div class="p-8 bg-surface text-text">
                ...
                <p class="text-sm text-text-secondary mb-6">
                    ...
                    <span class="font-bold text-text">{{
                        selectedToken?.device_name || "dispositivo"
                    }}</span>
                </p>

                <div class="space-y-4">
                    <div>
                        <InputLabel for="type" value="Tipo de Acción" />
                        <select
                            id="type"
                            v-model="form.type"
                ...
                <div class="mt-8 flex justify-end gap-3 font-bold">
                    <SecondaryButton @click="closeNotificationModal">
                        Cancelar
                    </SecondaryButton>
